...
archived: 2026-05-31
status: superseded
superseded-by: ../SKILL.md
note: >
  Archived version of the stack-setup skill. This was the original
  Vite + Fastify + Docker-Postgres + Tailwind + TanStack Query stack.
  Superseded on 2026-05-31 by a Vercel-focused stack (Next.js App Router,
  SCSS, SWR, Redux Toolkit, pgvector). Kept for reference only — do not load
  this as the active skill.
---

# ARCHIVED — Standard Project Stack (pre-2026-05-31)

> This file is an archived snapshot. The active stack-setup skill lives at
> `.claude/skills/stack-setup/SKILL.md`. Everything below is the previous
> version, retained for historical reference.
